...
//
            if ($_GET['paymentworkorder'] == "Software Maintenance" || $_GET['paymentworkorder'] == "Hardware AMC") {
                ...
                $from = \Carbon\Carbon::createFromFormat('Y-m-d', $fromdate);
                $to = \Carbon\Carbon::createFromFormat('Y-m-d', $todate);
                $months = $to->diffInMonths($from);
...
//            $date = $to->diffInYears($from);
    ...
    public function amendcontractcreatenewcontract(Request $request, $contractno)
    {
        ...
        $to = \Carbon\Carbon::createFromFormat('Y-m-d', $request->contractfromdate);
        $from = \Carbon\Carbon::createFromFormat('Y-m-d', $request->contracttodate);
        $months = $to->diffInMonths($from);

...
//        $workorder = EquipmentMasterModel::where('contractno', $id)->get()->first();
        ...
        if($equipmentnull == null)
        {
            ...
            return view('supplymanagement.assignee', compact('equipmentnull'));
        }
        else
        {
            $serviceId = SupplyManagementModel::where('contractno',$id)->pluck('id')->first();
        ...
        return view('supplymanagement.assignee', compact('equipmentnull', 'equipment', 'productnames', 'branches', 'equipmentforlooping','serviceId'));
    }



    public function getchkvaluessupply()
    {

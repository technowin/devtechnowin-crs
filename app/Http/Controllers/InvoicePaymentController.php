...
//        $company = CompanyMasterModel::where('address','=','Malad')->get()->first();
    ...
    public function downloadinv(Request $request)
    {
        ...
        $invoicedetails=$contractinvoicedetails->first();
        $convertrupee = $this->convertNumberToWord($invoicedetails->invoiceamount);
        $pdf = \PDF::loadView('invoicepayment.pdfview',compact('invoicedetails','contractinvoicedetails','convertrupee','workordercustomer','contractmatsrs','contractsdetails','company'));
...
//    supply
    ...
    public function supplyinvoice($contractno,$paymentcycle)
    {
        ...
        return view('invoicepayment.supplygenrateinvoice',compact('supplymanagement','contractdetails','paymentype','customer','paymentpercent','totalamount','contractinvoicedetails'));
    }

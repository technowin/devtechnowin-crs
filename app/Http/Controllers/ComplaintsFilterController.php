...
//               $totalFiltered = ExistingUserComplaintLodging::where('ticketno','LIKE',"%{$search}%")
    ...
    public function allStatusView($ticketno){
        try {
            ...
            return view('complaint.allcomplaintstatusview', compact('ticketnumber', 'equipement', 'subcategorycode', 'customercode','filedetails', 'user', 'previouslyassignedto','status'));

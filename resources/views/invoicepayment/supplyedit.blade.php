    ...
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Edit Invoice No</h3>
            </div>
            <div class="panel-body">
                {{--                {{ Form::open(array('url' => 'invdetails/'.$id,'files' => true,'id'=>'invoicedatailid')) }}--}}
                {{ Form::open(array('url' => 'supplyupdate/','files' => true,'id'=>'supplyupdate')) }}

                <div class="row{{ $errors->has('sectorname') ? ' has-error' : '' }}">
                    <label for="input" class="col-sm-4 col-form-label text-muted">Invoicebill No</label>
                    <div class="col-sm-6">
                        {{ Form::text('invoicebillno', $invoicedetails->invoicebillno, array('class' => 'form-control form-control-sm','readonly' => true)) }}
                    </div>
                </div>
                <div class="row{{ $errors->has('sectorname') ? ' has-error' : '' }}">
                    <label for="input" class="col-sm-4 col-form-label text-muted">Contract No</label>
                    <div class="col-sm-6">
                        {{ Form::text('contractno', $invoicedetails->contractno, array('class' => 'form-control form-control-sm','readonly' => true)) }}
                    </div>
                </div>
                ...
                <div class="row{{ $errors->has('paymentype') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        {{ Form::text('paymentype',$contractpaymentschedule->paymentype, array('class' => 'form-control form-control-sm','readonly'=>true)) }}
                    </div>
                </div>
                ...
                <div>{{Form::hidden('paymentpercent',$paymentpercent,array('id'=>'paymentpercent'))}}</div>
{{--                <div>{{ Form::text('srmdate',$invoicedetails->srmdate, array('class' => 'form-control','hidden'=>'true')) }}</div>--}}
{{--                <div>{{Form::hidden('serviceparametersid',$serviceparametersid->id,array('id'=>'serviceparametersid'))}}</div>--}}
                ...
                <table width="100%;" id="invtable">
                    ...
                    @foreach($contractinvoicedetails as $contract)
                        <tr>
                            <td style="width:150px; text-align: center;">{{ Form::text('productservicename[]', $contract->equipmenttype, array('class' => 'form-control','required' => 'required','readonly')) }}</td>
                            ...
                            <td style="width:150px; text-align: center;">{{ Form::text('amount[]',$contract->amount, array('class' => 'form-control','readonly')) }}</td>
                            <td style="width:150px; text-align: center;">{{ Form::text('cgstamt[]',$contract->cgstamount, array('class' => 'form-control','readonly')) }}</td>
                            <td style="width:150px; text-align: center;">{{ Form::text('sgstamt[]',$contract->sgstamount, array('class' => 'form-control','required' => 'required','readonly')) }}</td>
                            <td style="width:150px; text-align: center;">{{ Form::text('taxamt[]',$contract->taxamount, array('class' => 'form-control','required' => 'required','readonly')) }}</td>
                            <td style="width:150px; text-align: center;">{{ Form::text('totalamount[]',$contract->totalamount,array('class' => 'form-control totalcost')) }}</td>
                            <td style="width:150px; text-align: center;">{{ Form::text('remark[]',$contract->remarks, array('class' => 'form-control')) }}</td>
...
{{--                            <td>{{ Form::text('totaltax[]', $contract->totaltax, array('class' => 'form-control','hidden'=>'true')) }}</td>--}}
                ...
                <div class="row{{ $errors->has('sectorname') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-4">
                        {{ Form::text('initialinvoiceamount',$contractinvoicedetails[0]->initialinvoiceamount, array('class' => 'form-control form-control-sm','readonly' => true)) }}
                    </div>
                </div>
                ...
                <div class="row{{ $errors->has('sectorname') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-4">
                        {{ Form::number('newtotal',$contractinvoicedetails[0]->invoiceamount , array('id'=>'newtotalid','class' => 'form-control form-control-sm')) }}
                    </div>
                </div>
                ...
                <div class="row{{ $errors->has('sectorname') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-4">
                        {{ Form::textarea('totalremark',$contractinvoicedetails[0]->totalremark, array('class' => 'form-control form-control-sm','rows'=>'2')) }}
                    </div>
                </div>
                <br>
...
@section('page-script')
    ...
    {{--<script type="text/javascript">--}}
        {{--$('#invtable').on('blur', 'tr', function () {--}}
            ...
            {{--var warrantyamcperiod=this.cells[13].children[0].value;--}}
            {{--if (quantity != "") {--}}
                ...
                {{--var totalamt=test*paymentpercent/100;--}}
                ...
                {{--this.cells[7].children[0].value=totalamt;--}}
            {{--}--}}
        {{--});--}}
    {{--</script>--}}

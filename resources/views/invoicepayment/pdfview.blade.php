...
{{--            <tr>--}}
{{--                <td colspan="3" align="center"><h1>Invoice Report </h1></td>--}}
{{--            </tr>--}}
{{--        </table>--}}
...
{{--                    <table>--}}
{{--                        <tr> <td style="margin-left:1px">Invoice No : {{$invoicedetails->invoicebillno}}</td></tr>--}}
{{--                        <tr> <td style="margin-left:1px">Date Of Invoice : {{ Form::label( $invoicedetails->invoicedate) }}</td></tr>--}}
{{--                        <tr> <td style="margin-left:1px">PO No :{{$contractmatsrs->purchaseorderno}}</td></tr>--}}

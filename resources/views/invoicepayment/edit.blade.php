    ...
    <div class="container">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                {{ Form::open(array('url' => 'invoiceupdate/','files' => true,'id'=>'invoiceupdate')) }}
                ...
                <div class="row{{ $errors->has('sectorname') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        {{ Form::text('paymentcycleno',$invoicedetails->paymentcycle, array('class' => 'form-control form-control-sm','readonly'=>true)) }}
                    </div>
                </div>
                ...
                <table width="100%;" id="invtable">
                    ...
                    @foreach($contractinvoicedetails as $contract)
                        <tr>
                            <td style="width:150px; text-align: center;">{{ Form::text('equipmenttype[]', $contract->equipmenttype, array('class' => 'form-control','required' => 'required','readonly')) }}</td>
                            ...
                            <td style="width:150px; text-align: center;">{{ Form::text('cgstamount[]',$contract->cgstamount, array('class' => 'form-control','required' => 'required','readonly')) }}</td>
                            <td style="width:150px; text-align: center;">{{ Form::text('sgstamount[]',$contract->sgstamount, array('class' => 'form-control','required' => 'required','readonly')) }}</td>
                            <td style="width:150px; text-align: center;">{{ Form::text('taxamount[]',$contract->taxamount, array('class' => 'form-control','required' => 'required','readonly')) }}</td>

                            <td style="width:150px; text-align: center;">{{ Form::text('totalamount[]', $contract->totalamount, array('class' => 'form-control totalcost','required' => 'required')) }}</td>
                            <td style="width:150px; text-align: center;">{{ Form::text('remarks[]',$contract->remarks, array('class' => 'form-control')) }}</td>
                ...
                <div class="row{{ $errors->has('sectorname') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-4">
                        {{ Form::text('initialinvoiceamount',$contractinvoicedetails[0]->initialinvoiceamount, array('id'=>'totalid','class' => 'form-control form-control-sm','readonly' => true)) }}
                    </div>
                </div>

...
<br>
{{ Form::open(array('url' => 'savesenddate/','files' => true,'id'=>'savesenddate')) }}
<div>
    <div align="center" style="padding-top: 7px; margin-right: 24px">
        <div><b>Send Invoice Date:</b>
        {{Form::date('invoicesentdate',null,array('id'=>'invoicesentdate','style=height:30px;width:250px;'))}}</div>
    </div>

    {{--<div align="center" id="final"  style="margin-right: 50px; margin-top: 7px;">--}}
        {{--<div><b>Final Invoice amount : </b>--}}
            {{--{{Form::number('finalinvoiceamount',null,array('id'=>'finalinvoiceamount','style=height:30px;width:250px;'))}}</div>--}}
    {{--</div>--}}
    {{--<div id="remarkid"  align="center" style="padding-top: 7px;padding-left: 30px;">--}}
        {{--<div ><b>Remarks :</b>--}}
            {{--{{Form::text('remarks',null,array('id'=>'remarks','style=height:30px;width:250px'))}}</div>--}}
    {{--</div>--}}
    <div align="center" style="padding-top: 7px;">
        <div>{{ Form::submit('Save',array('class'=>'btn btn-primary'))}} <a href="{{ URL::previous()}}">{{ Form::button(' Back ',array('class'=>'btn btn-primary'))}}</a></div>
    </div>

    <div>
        {{Form::hidden('invoicebillno',$invoicedetails->invoicebillno)}}
    </div>
</div>

{{--<table align="center" style="width:95%; border:hidden">--}}

    {{--<tr style="height: 25px; padding-top: 7px">--}}
        {{--<td align="right"><b>Send Invoice Date</b></td>--}}
        {{--<td align="left">{{Form::date('invoicesentdate','style=height:30px;width:300px;')}}</td>--}}
        {{--<td colspan="2" align="center">{{ Form::submit('Save',array('class'=>'btn btn-primary'))}} <a href="{{ URL::previous()}}">{{ Form::button(' Back ',array('class'=>'btn btn-primary'))}}</a></td>--}}
        {{--{{Form::hidden('invoicebillno',$invoicedetails->invoicebillno)}}--}}
    {{--</tr>     --}}
    {{--</table>--}}

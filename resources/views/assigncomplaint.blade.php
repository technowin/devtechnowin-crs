...
@section('content')
            ...
            <div class="panel-body">
                <div class="container">
                    ...
                    <div class="row{{ $errors->has('ticketnumber') ? ' has-error' : '' }} mt-1">
                        ...
                        <div class="col-sm-6">
                            {{ Form::text('ticketnumber', $ticketnumber, array('class' => 'form-control','required' => 'required','readonly' => true,'style'=>'background-color:white;')) }}
                        </div>
                    </div>
                    <div class="row{{ $errors->has('assignees') ? ' has-error' : '' }} mt-1">
                        ...
                        <div class="col-sm-6">
                            {{ Form::select('assignees', $assignees, null, array('placeholder' => '--SELECT--','id' => 'assignees','required' => 'required')) }}
                    ...
                    <div class="row{{ $errors->has('startdate') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-6">
                            {{ Form::date('startdate', null, array('required' => 'required', 'class' => 'form-control','required' => 'required','id'=>'startdate')) }}
                    ...
                    <div class="row{{ $errors->has('enddate') ? ' has-error' : '' }} mt-1">
                        ...
                        <div class="col-sm-6">
                            {{ Form::date('enddate', null, array('required' => 'required', 'class' => 'form-control','required' => 'required','id'=>'enddate')) }}
    ...
    {{--<div class="col-md-6"><h5 class="card-title text-muted">Assign Complaint</h5></div>--}}

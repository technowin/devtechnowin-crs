                ...
                <div class="tab-pane fade active in" role="tabpanel" id="contract-tab" style="margin-left: 250px;">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            {{ Form::open(array('url' => 'prospectivequotationupdate/'.$ProspectiveQutation->id,'files' => true)) }}
                            <div class="row{{ $errors->has('quotationno') ? ' has-error' : '' }}" style="padding: 3px">
                                ...
                                <div class="col-sm-6">
                                    {{ Form::text('quotationno', $ProspectiveQutation->quotationno, array('placeholder' => 'Quotation No','required' => 'required', 'class' => 'form-control form-control-sm','required' => 'required', 'onKeyUp' => 'checktenderno();return false;', 'id' => 'tenderno','readonly')) }}
                                    @if ($errors->has('quotationno'))
                                        <span class="help-block"><strong>{{ $errors->first('quotationno') }}</strong></span>
                                    @endif
                                </div>
                            </div>
                            <div class="row{{ $errors->has('quotationdate') ? ' has-error' : '' }}" style="padding: 3px">
                                ...
                                <div class="col-sm-6">
                                    {{ Form::date('quotationdate',$quotationdate,  array('class' => 'form-control form-control-sm')) }}
                            ...
                            <div class="row{{ $errors->has('organizationname') ? ' has-error' : '' }}" style="padding: 3px">
                                ...
                                <div class="col-sm-6">
                                    {{ Form::select('organizationname', $organisationname, $organisationnamecode, array('placeholder' => 'select','required' => 'required','id'=>'organisationnameid' )) }}
                            ...
                            <div class="row{{ $errors->has('organizationaddress') ? ' has-error' : '' }}" style="padding: 3px">
                                ...
                                <div class="col-sm-6">
                                    {{ Form::textarea('organizationaddress',$ProspectiveQutation->organizationaddress , array('placeholder' => 'Organisation Address', 'class' => 'form-control form-control-sm', 'rows' => '2')) }}
                            ...
                            <div class="row{{ $errors->has('organizationaddress') ? ' has-error' : '' }}" style="padding: 3px">
                                ...
                                <div class="col-sm-6">
                                    {{ Form::email('emailid',$ProspectiveQutation->emailid , array('placeholder' => 'Email', 'class' => 'form-control form-control-sm', 'rows' => '2')) }}
                                    @if ($errors->has('organizationaddress'))
                                        <span class="help-block"><strong>{{ $errors->first('organizationaddress') }}</strong></span>
                                    @endif
                                </div>
                            ...
                            <div class="row{{ $errors->has('organizationaddress') ? ' has-error' : '' }}" style="padding: 3px">
                                ...
                                <div class="col-sm-6">
                                    {{ Form::number('phone',$ProspectiveQutation->phone , array('placeholder' => 'Phone', 'class' => 'form-control form-control-sm', 'rows' => '2')) }}
                                    @if ($errors->has('organizationaddress'))
                                        <span class="help-block"><strong>{{ $errors->first('organizationaddress') }}</strong></span>
                                    @endif
                                </div>
                            ...
                            <div class="row{{ $errors->has('organizationaddress') ? ' has-error' : '' }}" style="padding: 3px">
                                ...
                                <div class="col-sm-6">
                                    {{ Form::textarea('subject',$ProspectiveQutation->subject , array('class' => 'form-control form-control-sm','rows'=>'2','required' => 'required')) }}
                                    @if ($errors->has('organizationaddress'))
                                        <span class="help-block"><strong>{{ $errors->first('organizationaddress') }}</strong></span>
                                    @endif
                                </div>
                            ...
                            <div class="row{{ $errors->has('description') ? ' has-error' : '' }}" style="padding: 3px">
                                ...
                                <div class="col-sm-6">
                                    {{ Form::textarea('description',$ProspectiveQutation->description , array('class' => 'form-control form-control-sm','rows'=>'2','required' => 'required')) }}
                            ...
                            @foreach($ProspectiveQutationdetails as $key => $ProspectiveQutation)
                                {{Form::hidden('prospectivequtationdetailsid[]',$ProspectiveQutation->id,array('class'=>'prospectivequtationdetails'))}}
                                <div class="panel col-md-12" style="border: silver 1px solid;">
                                    <div class="row{{ $errors->has('productservicecode') ? ' has-error' : '' }} mt-1"
                                         style="margin-top: 20px;">
                                        <label for="input" class="col-sm-4 col-form-label text-muted">Product</label>
                                        <div class="col-sm-6">
                                            {{ Form::select('productservicecode[]',$product,$ProspectiveQutation->productservicecode, array('class'=>'selectize')) }}
                                            @if ($errors->has('productservicecode'))
                                                <span class="help-block"><strong>{{ $errors->first('productservicecode') }}</strong></span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row{{ $errors->has('categorycode') ? ' has-error' : '' }} mt-1"
                                         style="margin-top: 20px;">
                                        <label for="input" class="col-sm-4 col-form-label text-muted"> Category </label>
                                        <div class="col-sm-6">
                                            {{ Form::select('categorycode[]',$category,$ProspectiveQutation->categorycode, array('class'=>'selectize')) }}
                                            @if ($errors->has('categorycode'))
                                                <span class="help-block"><strong>{{ $errors->first('categorycode') }}</strong></span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row{{ $errors->has('modelno') ? ' has-error' : '' }} mt-1">
                                        <label for="input" class="col-sm-4 col-form-label text-muted">Model No</label>
                                        <div class="col-sm-6">
                                            {{ Form::text('modelno[]',$ProspectiveQutation->modelno, array('class' => 'form-control form-control-sm')) }}
                                            @if ($errors->has('modelno'))
                                                <span class="help-block"><strong>{{ $errors->first('modelno') }}</strong></span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row{{ $errors->has('configuration') ? ' has-error' : '' }} mt-1">
                                        <label for="input" class="col-sm-4 col-form-label text-muted">Configuration</label>
                                        <div class="col-sm-6">
                                            {{ Form::textarea('configuration[]',$ProspectiveQutation->configuration, array('class' => 'form-control form-control-sm','rows' => '2')) }}
                                            @if ($errors->has('configuration'))
                                                <span class="help-block"><strong>{{ $errors->first('configuration') }}</strong></span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row{{ $errors->has('qty') ? ' has-error' : '' }} mt-1">
                                        <label for="input" class="col-sm-4 col-form-label text-muted">Qty</label>
                                        <div class="col-sm-6">
                                            {{--{{ Form::number('rate[]',$ProspectiveQutation->rate, array('class' => 'form-control form-control-sm','onkeyup'=>'calculater(%id%); return false;')) }}--}}
                                            <input type="text" class="form-control" name="qty[]" value="{{$ProspectiveQutation->qty}}" id="qtyid_{{$key+1}}" onkeyup="calculater({{$key+1}}); return false;">
                                            @if ($errors->has('qty'))
                                    ...
                                    <div class="row{{ $errors->has('rate') ? ' has-error' : '' }} mt-1">
                                        ...
                                        <div class="col-sm-6">
                                            {{--{{ Form::number('rate[]',$ProspectiveQutation->rate, array('class' => 'form-control form-control-sm','onkeyup'=>'calculater(%id%); return false;')) }}--}}
                                            <input type="text" class="form-control" name="rate[]" value="{{$ProspectiveQutation->rate}}" id="rateid_{{$key+1}}" onkeyup="calculater({{$key+1}}); return false;">
                                            @if ($errors->has('rate'))
                                                <span class="help-block"><strong>{{ $errors->first('rate') }}</strong></span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row{{ $errors->has('sgst') ? ' has-error' : '' }} mt-1">
                                        <label for="input" class="col-sm-4 col-form-label text-muted">SGST</label>
                                        <div class="col-sm-6">
                                            {{--{{ Form::number('sgst[]',$ProspectiveQutation->sgst, array('class' => 'form-control form-control-sm','onKeyPress'=>'if(this.value.length==11) return false;')) }}--}}
                                            <input type="text" class="form-control" name="sgst[]" value="{{$ProspectiveQutation->sgst}}" id="sgstid_{{$key+1}}" onkeyup="calculater({{$key+1}}); return false;">
                                            @if ($errors->has('sgst'))
                                                <span class="help-block"><strong>{{ $errors->first('sgst') }}</strong></span>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="row{{ $errors->has('fax') ? ' has-error' : '' }} mt-1">
                                        ...
                                        <div class="col-sm-6">
                                            {{--{{ Form::number('sgstamt[]',$ProspectiveQutation->sgstamt, array('class' => 'form-control form-control-sm','onKeyPress'=>'if(this.value.length==11) return false;')) }}--}}
                                            <input type="text" class="form-control" name="sgstamt[]" value="{{$ProspectiveQutation->sgstamt}}" id="sgstamtid_{{$key+1}}" onkeyup="calculater({{$key+1}}); return false;" readonly>
                                            @if ($errors->has('sgst'))
                                                <span class="help-block"><strong>{{ $errors->first('sgstamt') }}</strong></span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row{{ $errors->has('cgst') ? ' has-error' : '' }} mt-1">
                                        <label for="input" class="col-sm-4 col-form-label text-muted">CGST</label>
                                        <div class="col-sm-6">
                                            {{--{{ Form::number('cgst[]',$ProspectiveQutation->sgstamt, array('class' => 'form-control form-control-sm','onKeyPress'=>'if(this.value.length==11) return false;')) }}--}}
                                            <input type="text" class="form-control" name="cgst[]" value="{{$ProspectiveQutation->cgst}}" id="cgstid_{{$key+1}}" onkeyup="calculater({{$key+1}}); return false;" >
                                            @if ($errors->has('cgst'))
                                                <span class="help-block"><strong>{{ $errors->first('cgst') }}</strong></span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row{{ $errors->has('cgstamt') ? ' has-error' : '' }} mt-1">
                                        ...
                                        <div class="col-sm-6">
                                            {{--{{ Form::number('cgstamt[]',$ProspectiveQutation->sgstamt, array('class' => 'form-control form-control-sm','onKeyPress'=>'if(this.value.length==11) return false;')) }}--}}
                                            <input type="text" class="form-control" name="cgstamt[]" value="{{$ProspectiveQutation->cgstamt}}" id="cgstamtid_{{$key+1}}" onkeyup="calculater({{$key+1}}); return false;" readonly>
                                            @if ($errors->has('cgstamt'))
                                                <span class="help-block"><strong>{{ $errors->first('cgstamt') }}</strong></span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row{{ $errors->has('amt') ? ' has-error' : '' }} mt-1">
                                        <label for="input" class="col-sm-4 col-form-label text-muted">Tax Amt</label>
                                        <div class="col-sm-6">
                                            {{--{{ Form::number('amt[]',$ProspectiveQutation->amt, array('class' => 'form-control form-control-sm')) }}--}}
                                            <input type="text" class="form-control" name="amt[]" value="{{$ProspectiveQutation->amt}}" id="amtid_{{$key+1}}" onkeyup="calculater({{$key+1}}); return false;" readonly>
                                            @if ($errors->has('amt'))
                                                <span class="help-block"><strong>{{ $errors->first('amt') }}</strong></span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="row{{ $errors->has('total') ? ' has-error' : '' }} mt-1">
                                        ...
                                        <div class="col-sm-6">
                                            {{--{{ Form::number('total[]',$ProspectiveQutation->total, array('class' => 'form-control form-control-sm','onKeyPress'=>'if(this.value.length==11) return false;')) }}--}}
                                            <input type="text" class="form-control" name="total[]" value="{{$ProspectiveQutation->total}}" id="totalid_{{$key+1}}" onkeyup="calculater({{$key+1}}); return false;" readonly>
                                            @if ($errors->has('total'))
                                    ...
                                    <div class="row{{ $errors->has('total') ? ' has-error' : '' }} mt-1">
                                        ...
                                        <div class="col-sm-6">
                                            {{--{{ Form::number('grandamt[]',$ProspectiveQutation->grandamt, array('class' => 'form-control form-control-sm','onKeyPress'=>'if(this.value.length==11) return false;')) }}--}}
                                            <input type="text" class="form-control" name="grandamt[]" value="{{$ProspectiveQutation->grandamt}}" id="grandtotalid_{{$key+1}}" onkeyup="calculater({{$key+1}}); return false;" readonly>
                                            @if ($errors->has('grandamt'))
                                                <span class="help-block"><strong>{{ $errors->first('grandamt') }}</strong></span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
...
//                maxItems: 1
        ...
        function addprospectivequotationdetails() {
            ...
            var appendtags = '<div><a  href="javascript:void(0);" class="remove_button" title="Remove field"><img src="{{asset('img/cancel-512.png')}}" style="height: 20px; width: 20px; margin-left:658px;"/></a><div class="panel col-md-12" style="border: silver 1px solid;"><div class="panel-body">{{ Form::hidden('prospectivequtationdetailsid[]', '0',array('class'=>'contractsitemasterclass')) }} <div class="row mt-1">' +
                ...
                '{{ Form::textarea('configuration[]', null, array('class' => 'form-control form-control-sm', 'id'=>'configurationid','required' => 'required','rows'=>'2')) }}</div></div>'+

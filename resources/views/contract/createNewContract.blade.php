    ...
    <div class="container">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                {{ Form::hidden('contractno', null, array('id' => 'paymentdetailscontractid')) }}
...
<div class="col-sm-2" style="padding-top:8px;">
    {{ Form::radio('formfeesexemption', 'Y', false, array('id'=>'formfeesexemptionY')) }} <label for="formfeesexemptionY">Y</label>
    &nbsp;&nbsp;
    {{ Form::radio('formfeesexemption', 'N', false, array('id'=>'formfeesexemptionN')) }} <label for="formfeesexemptionN">N</label>
</div>
                ...
                <div class="row mt-1">
                    ...
                    <label class="col-sm-2 col-form-label text-muted">Exemption</label>
<div class="col-sm-2" style="padding-top:8px;">
    {{ Form::radio('emdexemption', 'Y', false, array('id'=>'emdexemptionY')) }} <label for="emdexemptionY">Y</label>
    &nbsp;&nbsp;
    {{ Form::radio('emdexemption', 'N', false, array('id'=>'emdexemptionN')) }} <label for="emdexemptionN">N</label>
</div>
                    <label class="col-sm-2 col-form-label text-muted">Date Paid</label>
                ...
                <div class="row mt-1">
                    ...
                    <label class="col-sm-2 col-form-label text-muted">Exemption</label>
<div class="col-sm-2" style="padding-top:8px;">
    {{ Form::radio('adminchargesexemption', 'Y', false, array('id'=>'adminchargesexemptionY')) }} <label for="adminchargesexemptionY">Y</label>
    &nbsp;&nbsp;
    {{ Form::radio('adminchargesexemption', 'N', false, array('id'=>'adminchargesexemptionN')) }} <label for="adminchargesexemptionN">N</label>
</div>
                    <label class="col-sm-2 col-form-label text-muted">Date Paid</label>
                ...
                <div class="row mt-1">
                    ...
                    <label class="col-sm-2 col-form-label text-muted">Exemption</label>
<div class="col-sm-2" style="padding-top:8px;">
    {{ Form::radio('facilitychargesexemption', 'Y', false, array('id'=>'facilitychargesexemptionY')) }} <label for="facilitychargesexemptionY">Y</label>
    &nbsp;&nbsp;
    {{ Form::radio('facilitychargesexemption', 'N', false, array('id'=>'facilitychargesexemptionN')) }} <label for="facilitychargesexemptionN">N</label>
</div>
                    <label class="col-sm-2 col-form-label text-muted">Date Paid</label>
                ...
                <div class="row mt-1">
                    ...
                    <label class="col-sm-2 col-form-label text-muted">Exemption</label>
<div class="col-sm-2" style="padding-top:8px;">
    {{ Form::radio('legalchargesexemption', 'Y', false, array('id'=>'legalchargesexemptionY')) }} <label for="legalchargesexemptionY">Y</label>
    &nbsp;&nbsp;
    {{ Form::radio('legalchargesexemption', 'N', false, array('id'=>'legalchargesexemptionN')) }} <label for="legalchargesexemptionN">N</label>
</div>
                    <label class="col-sm-2 col-form-label text-muted">Date Paid</label>
                ...
                <div class="row mt-1">
                    ...
                    <label class="col-sm-2 col-form-label text-muted">Exemption</label>
<div class="col-sm-2" style="padding-top:8px;">
    {{ Form::radio('addnlsecuritydepositexemption', 'Y', false, array('id'=>'addnlsecuritydepositexemptionY')) }} <label for="addnlsecuritydepositexemptionY">Y</label>
    &nbsp;&nbsp;
    {{ Form::radio('addnlsecuritydepositexemption', 'N', false, array('id'=>'addnlsecuritydepositexemptionN')) }} <label for="addnlsecuritydepositexemptionN">N</label>
</div>
                    <label class="col-sm-2 col-form-label text-muted">Date Paid</label>
                ...
                <div class="row mt-1">
                    ...
                    <div class="col-sm-6">
                        <input type="file" name="doc1" id="doc1id" class="form-control form-control-sm">
                        <div id="doc1existing"></div>
                    </div>
                </div>
                <div class="row mt-1">
                    <label class="col-sm-3 col-form-label text-muted">Document 2</label>
                    <div class="col-sm-6">
                        <input type="file" name="doc2" id="doc2id" class="form-control form-control-sm">
                        <div id="doc2existing"></div>
                    </div>
                </div>
                <div class="row mt-1">
                    <label class="col-sm-3 col-form-label text-muted">Document 3</label>
                    <div class="col-sm-6">
                        <input type="file" name="doc3" id="doc3id" class="form-control form-control-sm">
                        <div id="doc3existing"></div>
                    </div>
                </div>
...
function loadPaymentDetails(contractno) {
    $.ajax({
        ...
        success: function (data) {
            if (data.paymentdetails) {
                ...
                $('[name="formfeesamount"]').val(pd.formfeesamount);
$('input[name="formfeesexemption"][value="' + pd.formfeesexemption + '"]').prop('checked', true);
$('[name="formfeesdatepaid"]').val(pd.formfeesdatepaid);

$('[name="emdamount"]').val(pd.emdamount);
$('input[name="emdexemption"][value="' + pd.emdexemption + '"]').prop('checked', true);
$('[name="emddatepaid"]').val(pd.emddatepaid);
$('[name="emdestimatedreturndate"]').val(pd.emdestimatedreturndate);
$('[name="emdreturnamount"]').val(pd.emdreturnamount);
$('[name="emdreturndate"]').val(pd.emdreturndate);

$('[name="securitydepositamount"]').val(pd.securitydepositamount);
$('[name="securitydeposittype"]').val(pd.securitydeposittype);
$('[name="securitydepositdatepaid"]').val(pd.securitydepositdatepaid);
$('[name="securitydepositestimatedreturndate"]').val(pd.securitydepositestimatedreturndate);
$('[name="securitydepositreturnamount"]').val(pd.securitydepositreturnamount);
$('[name="securitydepositreturndate"]').val(pd.securitydepositreturndate);

$('[name="adminchargesamount"]').val(pd.adminchargesamount);
$('input[name="adminchargesexemption"][value="' + pd.adminchargesexemption + '"]').prop('checked', true);
$('[name="adminchargesdatepaid"]').val(pd.adminchargesdatepaid);

$('[name="facilitychargesamount"]').val(pd.facilitychargesamount);
$('input[name="facilitychargesexemption"][value="' + pd.facilitychargesexemption + '"]').prop('checked', true);
$('[name="facilitychargesdatepaid"]').val(pd.facilitychargesdatepaid);

$('[name="legalchargesamount"]').val(pd.legalchargesamount);
$('input[name="legalchargesexemption"][value="' + pd.legalchargesexemption + '"]').prop('checked', true);
$('[name="legalchargesdatepaid"]').val(pd.legalchargesdatepaid);

$('[name="addnlsecuritydepositamount"]').val(pd.addnlsecuritydepositamount);
$('input[name="addnlsecuritydepositexemption"][value="' + pd.addnlsecuritydepositexemption + '"]').prop('checked', true);
$('[name="addnlsecuritydepositdatepaid"]').val(pd.addnlsecuritydepositdatepaid);
$('[name="addnlsecuritydepositrefunddate"]').val(pd.addnlsecuritydepositrefunddate);
            }
            ...
            if (data.document) {
                ...
                updatePaymentDocDisplay('doc1', doc.doc1, contractno, '#doc1existing');
                updatePaymentDocDisplay('doc2', doc.doc2, contractno, '#doc2existing');
                updatePaymentDocDisplay('doc3', doc.doc3, contractno, '#doc3existing');
            }
        }
    });
}
...
$(document).ready(function () {
    $('#payment-details').click(function () {
        ...
        if (contractno && contractno != '0') {
            $('#paymentdetailscontractid').val(contractno);
            loadPaymentDetails(contractno);
        }
    });
...
function loadBillingDetails(contractno) {   // (view screen: loadBillingDetailsEditable)
    $.ajax({

    ...
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                {{ Form::hidden('is_amendment', '1', array('id' => 'is_amendment')) }}
...
<script type="text/javascript">
    // For amend page - these variables will be used if you add document upload on amend page
    var subtype = 'amend';
    var equipmentSubtype = 'amend_equipment';
    
    // You can also set a global variable that other scripts can use
    window.isAmendment = true;
</script>
@endsection
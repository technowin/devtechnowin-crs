            ...
            @foreach($contracts as $key => $contract)
                <tr>
                    ...
                    <td>{{ $contract->contracttodate }}</td> -->
                      ...
                      <td>{{ $contract->contractfromdate ? \Carbon\Carbon::parse($contract->contractfromdate)->format('d-m-Y') : '-' }}</td>
        <td>{{ $contract->contracttodate ? \Carbon\Carbon::parse($contract->contracttodate)->format('d-m-Y') : '-' }}</td>

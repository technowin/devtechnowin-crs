    ...
    <div class="container card col-md-9">
        <div class="col card-block">
            <div class="row"  style="border-bottom: 1px solid darkgray">
                <div class="col-md-6"><h5 class="card-title text-muted">Edit Sales Lead</h5></div>
                <div class="col-md-6"><img src="{{ asset('images/addcomplaint.png') }}" width="40" height="40" style="float: right; margin-top: -15px"/></div>
            </div>

            <div class="container">
                <br>
                {{ Form::open(array('url' => 'saleslead/editlead','onsubmit' => 'return checkvalidation();')) }}
                ...
                <div class="row{{ $errors->has('meetingdate') ? ' has-error' : '' }}" style="padding: 3px">
                    ...
                    <div class="col-sm-6">
                        {{ Form::date('meetingdate', $meetingdate, array(
                ...
                <div class="row{{ $errors->has('customername') ? ' has-error' : '' }}" style="padding: 3px">
                    ...
                    <div class="col-sm-6">
                        {{ Form::text('customername', $customername, array('placeholder' => 'Customer Name','required' => 'required', 'class' => 'form-control form-control-sm')) }}
                ...
                <div class="row{{ $errors->has('customeraddress') ? ' has-error' : '' }}" style="padding: 3px">
                    ...
                    <div class="col-sm-6">
                        {{ Form::textarea('customeraddress',$customeraddress , array('placeholder' => 'Customer Address', 'class' => 'form-control form-control-sm', 'rows' => '2')) }}
                ...
                <div class="row{{ $errors->has('customermobileno') ? ' has-error' : '' }}" style="padding: 3px">
                    ...
                    <div class="col-sm-6">
                        {{ Form::number('customermobileno', $customermobileno, array('placeholder' => 'Customer Mobile No', 'class' => 'form-control form-control-sm')) }}
                ...
                <div class="row{{ $errors->has('customeremail') ? ' has-error' : '' }}" style="padding: 3px">
                    ...
                    <div class="col-sm-6">
                        {{ Form::email('customeremail', $customeremail, array('placeholder' => 'Customer Email Id', 'class' => 'form-control form-control-sm')) }}
                ...
                <div class="row{{ $errors->has('product') ? ' has-error' : '' }}" style="padding: 3px">
                    ...
                    <div class="col-sm-6">
                        {{ Form::select('product[]', $productservice, $product, array('placeholder' => '--SELECT--', 'id' => 'productservice', 'multiple'=>'multiple')) }}
                ...
                <div class="row{{ $errors->has('salescomment') ? ' has-error' : '' }}" style="padding: 3px">
                    ...
                    <div class="col-sm-6">
                        {{ Form::textarea('salescomment',$salescomment , array('placeholder' => 'Sales Comment', 'class' => 'form-control form-control-sm', 'rows' => '2')) }}
                ...
                <div class="row{{ $errors->has('futureaction') ? ' has-error' : '' }}" style="padding: 3px">
                    ...
                    <div class="col-sm-6">
                        {{ Form::textarea('futureaction',$futureaction , array('placeholder' => 'Future Action', 'class' => 'form-control form-control-sm', 'rows' => '2')) }}
                ...
                <div class="row{{ $errors->has('futureactiondate') ? ' has-error' : '' }}" style="padding: 3px">
                    ...
                    <div class="col-sm-6">
                        {{ Form::date('futureactiondate', $futureactiondate, array('class' => 'form-control form-control-sm')) }}
                ...
                <div class="row{{ $errors->has('salesorderreceived') ? ' has-error' : '' }}" style="padding: 3px">
                    ...
                    <div class="col-sm-6">
                        {{ Form::select('salesorderreceived', array(''=>'--SELECT--','Yes'=>'Yes', 'No'=>'No'), $salesorderreceived, array('class' => '', 'id' => 'salesorderreceived')) }}

...
@section('content')
            ...
            <div class="panel-body">
                <div class="container">
                    ...
                    <div class="row col-lg-12">
                        ...
                        <div class="col-sm-3">
                            <div class="col-sm-3">
                                @if($ticketnumber->productservicename != null)
                                    <b>{{ $ticketnumber->productservicename }}</b>
                                @else
                                    {{ Form::label('productservice',"-") }}
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row col-lg-12">
                        ...
                        <div class="col-sm-3">
                            @if($ticketnumber->subcategoryname != null)
                                <b>{{ $ticketnumber->subcategoryname }}</b>
                            @else
                    ...
                    <div class="row col-lg-12">
                        ...
                        <div class="col-sm-3">
                            {{ Form::label('productserialno', $ticketnumber->productsrno )  }}
                    ...
                    <div class="row col-lg-12">
                        ...
                        <div class="col-sm-3">
                            @if($ticketnumber->updated_by != null)
                                {{ Form::label('updated_by', $ticketnumber->updated_by) }}
                            @else
    ...
    @if($status != "ACKNOWLEDGED" && $previouslyassignedto != ""  )
        <div class="container">
            <div class="panel panel-default">
                <div class="panel-heading">

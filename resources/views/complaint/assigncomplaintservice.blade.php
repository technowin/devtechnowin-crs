    ...
    <div class="container" style="padding-left: 100px;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="container">
                    <br>
                    {{Form::open(array('id' => 'assignee','action' => 'ComplaintHandlingController@store','method' => 'post', 'role' => 'form', 'invalidate' => 'invalidate', 'files'=>true, 'onsubmit' => 'return chkdropvalues();'))}}

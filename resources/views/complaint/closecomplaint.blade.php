    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                {{Form::open(array('action' => array('CustomerComplaintListController@closecomplaintupdate',$id),'method' => 'post', 'role' => 'form', 'invalidate' => 'invalidate'))}}
                {{--{{ Form::open(array('url' => 'complaints/close',$complaintDetail->id)) }}--}}
                <div class="row">

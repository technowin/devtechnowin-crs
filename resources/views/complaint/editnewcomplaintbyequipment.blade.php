    ...
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><span class="text-muted">Edit Complaint By Equipment <small> ( admin access )</small></span>
                </h3>
            </div>
            <div class="panel-body">
                {{ Form::open(array('url' => 'updatenewcomplaintbyequipment','files' => true ,'id'=>'form')) }}
                ...
                <div class="row{{ $errors->has('customers') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        {{ Form::text('customers',  $customercode->customername, array('class'=>'form-control', 'id' => 'customers','readonly'=>'true')) }}
                        @if ($errors->has('customers'))
                            <span class="help-block"><strong>{{ $errors->first('customers') }}</strong></span>
                        @endif
                    </div>
                ...
                <div class="row{{ $errors->has('productserialno') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        {{ Form::text('productserialno',  $equipmentcode, array('id' => 'productserialno','class'=>'form-control','readonly'=>'true')) }}
                        @if ($errors->has('productserialno'))
                            <span class="help-block"><strong>{{ $errors->first('productserialno') }}</strong></span>
                        @endif
                    </div>
                </div><div class="row{{ $errors->has('productsrno') ? ' has-error' : '' }}">
                    <label for="input" class="col-sm-4 col-form-label text-muted">Product Serial No</label>
                    <div class="col-sm-6">
                        {{ Form::text('productsrno',$productcode, array('id' => 'productsrno','class'=>'form-control','readonly'=>'true')) }}
                ...
                <div class="row{{ $errors->has('workorderno') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        {{ Form::text('workorderno',$workordercode, array('id' => 'workordernoid','readonly'=>'true','class'=>'form-control')) }}
                ...
                <div class="row{{ $errors->has('customersite') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        {{ Form::text('customersite',$customersitecode, array('id' => 'customersite','readonly'=>'true','class'=>'form-control')) }}
                ...
                <div class="row{{ $errors->has('category') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        {{ Form::text('category',$categorycode, array('class'=>'form-control', 'id' => 'category','readonly'=>'true')) }}
                        @if ($errors->has('productservice'))
                ...
                <div class="row{{ $errors->has('sub-category') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        {{ Form::text('subcategory',  $subcategorycode, array('id' => 'subcategory', 'rel' => URL::to('/'),'readonly'=>'true','class'=>'form-control')) }}
...
{{--                        {{ Form::text('callername', $data->callername, array('class' => 'form-control')) }}--}}
                        {{ Form::text('callername',$data->callername, array('id' => 'callernameidd','readonly'=>'true','class'=>'form-control')) }}
                ...
                <div class="row{{ $errors->has('callermobile') ? ' has-error' : '' }}" style="margin-top: 0.5rem;">
                    ...
                    <div class="col-sm-6">
                        {{ Form::number('callermobile',$data->mobilenumber , array('class' => 'form-control','required' => 'required','min' => 0,'onKeyPress' => "if(this.value.length==10) return false;",'id'=>'callermobilenoid','readonly'=>'true' )) }}
                ...
                <div class="row{{ $errors->has('calleremail') ? ' has-error' : '' }}" style="margin-top: 0.5rem;">
                    ...
                    <div class="col-sm-6">
                        {{ Form::email('calleremail',$data->emailid, array('class' => 'form-control','required' => 'required','id'=>'calleremailid','readonly'=>'true')) }}
...
@section('selectize-script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            {{--                {--}}
            {{--                    $('#callernameidd').append('<option  value="'+data.branchcontactlist[0].contactpersonname+'" selected>'+data.branchcontactlist[0].contactpersonname+'</option>');--}}
            {{--                    $('#callernameidd').selectize({--}}
            {{--                        delimiter: ',',--}}
            {{--                        persist: false,--}}
            {{--                        create: function(input) {--}}

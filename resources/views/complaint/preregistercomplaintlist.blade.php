                ...
                <table class="table table-sm table-hover">
                    ...
                    @foreach($tblusercomplaintlodging as $key => $value)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('users.edit', $value->ticketno) }}" style="margin-right: 3px;">view</a> |
                                <a href="{{ route('users.edit', $value->ticketno) }}" style="margin-right: 3px;">edit</a> |
                                <a href="{{ route('users.edit', $value->ticketno) }}" style="margin-right: 3px;">delete</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>

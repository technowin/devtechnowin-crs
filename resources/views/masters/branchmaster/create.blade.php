    ...
    <div class="container card col-md-8">
        <div class="col card-body">
            <div class="row"  style="border-bottom: 1px solid darkgray">
                <div class="col-md-6"><h5 class="card-title text-muted">Add Branch </h5></div>
            ...
            <div class="container">
                ...
                <div class="row{{ $errors->has('branchname') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        {{ Form::text('branchname', '', array('class' => 'form-control form-control-sm','required' => 'required')) }}
                ...
                <div class="row{{ $errors->has('customercode') ? ' has-error' : '' }}">
                    <label for="input" class="col-sm-4 col-form-label text-muted">Customer Name</label>
                    <div class="col-sm-6">
                        {{ Form::select('costomercode', $costomercode, null, array('placeholder' => 'select','required' => 'required', 'id'=>'customercode')) }}
                        @if ($errors->has('costomercode'))

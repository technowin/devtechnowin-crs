    ...
    <div class="card">
        <div class="card-block">
            <div class="col-md-12 row">
                <div class="col-md-6"><h6 class="card-subtitle text-muted mt-2">Sector Master</h6></div>
                ...
                <div class="col-md-2">
                    <a class="btn btn-outline-secondary" href="{{ route('sectors.create') }}" style="color:gray;"> <b>Add
                            New Sector</b> </a>
                </div>

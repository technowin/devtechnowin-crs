    ...
    <div class="container card col-md-8">
        <div class="col card-body">
            <div class="row"  style="border-bottom: 1px solid darkgray">
                <div class="col-md-6"><h5 class="card-title text-muted">Add Sector</h5></div>
            ...
            <div class="container">
                ...
                <div class="row{{ $errors->has('sectorname') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        {{ Form::text('sectorname', '', array('class' => 'form-control form-control-sm','required' => 'required')) }}
                        @if ($errors->has('sectorname'))
                            <span class="help-block"><strong>{{ $errors->first('sectorname') }}</strong></span>
                        @endif
                    </div>
                </div>
                ...
                <div class="row{{ $errors->has('sectordescription') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        {{ Form::textarea('sectordescription', '', array('rows'=>3,'class' => 'form-control form-control-sm','required' => 'required')) }}

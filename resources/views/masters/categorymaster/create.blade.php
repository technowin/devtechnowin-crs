    ...
    <div class="container card col-md-8">
        <div class="col card-body">
            <div class="row"  style="border-bottom: 1px solid darkgray">
                <div class="col-md-6"><h5 class="card-title text-muted">Add Category </h5></div>
            ...
            <div class="container">
                ...
                <div class="row{{ $errors->has('productservicecode') ? ' has-error' : '' }}">
                ...
                <div class="row{{ $errors->has('calleremail') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        {{ Form::select('isactive', array('select'=>'--SELECT--','1' => 'Yes','0' => 'No'),null, array('placeholder' => 'select','required' => 'required', 'class' => 'form-control form-control-sm')) }}
